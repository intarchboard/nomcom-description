...
Administrative support groups assist the IAB in carrying out
its responsibilities to the community.
To ensure that all IAB activities have IAB participation,
...
In addition, the IAB selects a Chair for a one-year term at the March IETF meeting, after
new members are seated.
There should be at least two members (among the newly selected slate and the
...
IAB members must be willing and able to collaborate with one another to develop a
shared viewpoint.
...
with experience and an interest in organizing such information exchanges with 
...
including a yearly strategy meeting, which is often but not always adjacent to the IAB strategy meeting. 
...
expected to cover and report on BoFs during the week.

The IAB typically holds an annual strategy meeting of one to three days, full-board meetings at 
